...
class Nav extends Component{
  ...
  render(){
    ...
    // <li className="nav-item nav-link"> <Link onClick={this.updateNotificationBadge} to='/'> Home {badge} </Link> </li>
    return(
      <nav className="navbar navbar-expand-lg navbar-dark bg-dark fixed-top" id="mainNav">
       <div className="container">
         <Link className="navbar-brand" to='/' id="navtext" onClick={this.updateNotificationBadge}>
